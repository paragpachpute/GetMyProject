      ...
      <div class="col-md-4">
        <section class="login-form">
          <form method="post" action="index.php" role="login">
            ...
            <input type="text" class="form-control input-lg" name="uname" placeholder="Name" required>
            <textarea class="form-control input-lg" name="status" placeholder="What's in your mind?" rows=3 required></textarea>
